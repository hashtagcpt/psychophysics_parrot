function [m,c] = zForwardLocalSlope(srcIm, sigma, theta)
% function [dstIm] = zForwardLocalSlope(srcIm, sigma, theta)
 
zDefarg('sigma', [64 16 8 4 2]); % list of standard deviations for gaussian derivative filters
zDefarg('theta',[0 45 90 135]); % list of orientations - NB take as value, so orientation >180 sign ignored
